...
namespace BethanysPieShop.Models
{
    public class ShoppingCart : IShoppingCart
    {
        ...
        {
            var cartItems = _bethanysPieShopDbContext.ShoppingCartItems.Where(s => s.ShoppingCartId == ShoppingCartId);
        ...
        {
           var total = _bethanysPieShopDbContext.ShoppingCartItems.Where(s => s.ShoppingCartId == ShoppingCartId).Select(s => s.Amount * s.Pie.Price).Sum();
           return total; 
        }
        ...
        public int RemoveFromCart(Pie pie)
        {
            ...
            var shoppingCartItem = _bethanysPieShopDbContext.ShoppingCartItems.Where(s => s.ShoppingCartId == ShoppingCartId && s.Pie.PieId == pie.PieId).FirstOrDefault();
            if (shoppingCartItem != null)
            {
